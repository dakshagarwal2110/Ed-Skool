...
class SingleTextLayoutPost extends StatelessWidget {
  final String caption;
  final String date;
  final String imageIdentifier;

  const SingleTextLayoutPost({
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.symmetric(
                          horizontal: AppSize.getWidth(14, context)),
                      child: ClipOval(
                        child: Image.asset(
                          imageIdentifier,
                          fit: BoxFit.cover,
                          width: AppSize.getWidth(30, context),
                          // Adjust the width as needed
                          height: AppSize.getHeight(
                              30, context), // Adjust the height as needed
                        ),
                      ),
                    ),
                    Padding(
